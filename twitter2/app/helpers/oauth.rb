helpers do
  def oauth_consumer
    raise RuntimeError, "You must set TWITTER_CONSUMER_KEY and TWITTER_CONSUMER_SECRET in your server environment." unless ENV['TWITTER_CONSUMER_KEY'] and ENV['TWITTER_CONSUMER_SECRET']

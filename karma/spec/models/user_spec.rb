...
describe User do
  ...
  describe '.page' do
    it 'returns the users offset by the page number passed in' do
      user_p1  = create(:user_with_karma, :total => 800, :points => 2)
      user_p2  = create(:user_with_karma, :total => 500, :points => 2)
      user_p3  = create(:user_with_karma, :total => 200, :points => 2)

      User.page(0, 1).should eq [user_p1]
      User.page(1, 1).should eq [user_p2]
      User.page(2, 1).should eq [user_p3]
    end
  end
